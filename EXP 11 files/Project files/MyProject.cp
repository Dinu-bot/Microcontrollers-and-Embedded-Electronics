#line 1 "D:/DINU UNI/UOK/Academic/Year 3/sem 1/Microcontrollers and Embedded Electronics Laboratory/EXP 11 files/Project files/MyProject.c"
unsigned int kp = 0;
int val = 0;
...
void main() {
 ...
 case 2: val = 4; break;
 case 3: val = 7; break;
 case 4: ResetCalculator(); continue;
 case 5: val = 2; break;
 case 6: val = 5; break;
 case 7: val = 8; break;
 case 8: val = 0; break;
